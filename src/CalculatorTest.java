...
public class CalculatorTest {
    ...
    public void calculateTwoTokensTestInvalidCommand() throws AssertException
    {
    	...
    	try
    	{
    		Calculator.calculateTwoTokens(new String[] {"Fake", "1"});
    		Assert.fail("Illegal command did not throw Exception");
    	}
    ...
    public void calculateThreeTokensTestValidAdd() throws AssertException
    {
   	 ...
   	 try
     {
         int result = Calculator.calculateThreeTokens(new String[] {"1", "+", "15"});
    ...
    public void calculateThreeTokensTestValidSubtract() throws AssertException
    {
   	 ...
   	 try
     {   
         int result2 = Calculator.calculateThreeTokens(new String[] {"1", "-", "15"});
         Assert.assertEquals(-14, result2);
     }
     catch (Exception e)
     {
         Assert.fail("Legal expression threw an Exception: " + e.getMessage());
    ...
    public void calculateThreeTokensTestValidDivide() throws AssertException
    {
   	 ...
   	 try
     {
         int result3 = Calculator.calculateThreeTokens(new String[] {"20", "/", "5"});
    ...
    public void calculateThreeTokensTestInvalidCommand() throws AssertException
    {
        // TODO: complete this test...
       	try
    	{
    		Calculator.calculateThreeTokens(new String[] {"1", "Command", "1"});
    		Assert.fail("Illegal command did not throw Exception");
    	}
    	catch(CalculatorException c)
    	{
    ...
    public void executeTestValidQuit() throws AssertException
    {
    	...
    	try 
    	{
    		Calculator.execute(new String[] {"pass"});
    		Assert.fail("Did not properly return quit");
    	}
    	catch(CalculatorException c)
    	{
    ...
    public void executeTestValidThreeTokens() throws AssertException
    {
        // TODO: complete this test...
    	 try
         {
             int result = Calculator.execute(new String[] {"1", "+", "15"});
             Assert.assertEquals(16, result);
             
             int result2 = Calculator.execute(new String[] {"1", "-", "15"});
             Assert.assertEquals(-14, result2);
             
             int result3 = Calculator.execute(new String[] {"20", "/", "5"});
             Assert.assertEquals(4, result3);
         }
         catch (Exception e)
         {
    ...
    public void executeTestInvalidTokenLength() throws AssertException
    {
    	...
    	try
    	{
    		...
    		Assert.fail("Invalid token length did not throw Exception");
    	}
    	catch(CalculatorException c)
    	{
    ...
    {
        // TODO: complete this test...
    		String result = Calculator.parseAndExecute(new String ("1 / 0"));
    ...
    {
        // TODO: complete this test...
    	String result = Calculator.parseAndExecute("1 l 2");
